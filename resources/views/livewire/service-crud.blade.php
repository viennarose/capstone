<div>
    <div class="card">
        <div class="card-header bg-info d-flex">
            <h3 class="text-center fw-bold mt-3" style="font-family: Fantasy;">Services</h3>
                    ...
                    <form action="" wire:submit.prevent='create'>
                        <div class="card-body">
                            <div class="form-group">
                                <input type="text" wire:model='service_type' name="service_type" id="service_type"
                    ...
                    <form action="" wire:submit.prevent='update({{$edit_id}})'>
                        <div class="card-body">
                            <div class="from-group mb-2">
                                ...
                                <input type="text" wire:model='edit_service_type' name="service_type" id="service_type"
